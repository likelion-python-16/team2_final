...
class Goal(models.Model):
    # 큰 목표 (예: 다이어트)
    user = models.ForeignKey("users.CustomUser", on_delete=models.CASCADE, related_name="goals")
    goal_type = models.CharField(max_length=20)

class DailyGoal(models.Model):
    # 하루 단위 목표
    user = models.ForeignKey("users.CustomUser", on_delete=models.CASCADE, related_name="daily_goals")
...
class GoalProgress(models.Model):
    # 실제 운동/체중 기록
    user = models.ForeignKey("users.CustomUser", on_delete=models.CASCADE, related_name="goal_progress")
