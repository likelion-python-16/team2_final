...
class WorkoutPlanSerializer(serializers.ModelSerializer):
    ...
    from .serializers import TaskItemSerializer as _TaskItemSerializer  # 자기참조 회피용
    tasks = _TaskItemSerializer(many=True, read_only=True)
...
class BulkTaskItemSerializer(serializers.Serializer):
    ...
    intensity = serializers.ChoiceField(
        choices=getattr(TaskItem, "IntensityLevel").choices, default="mid"
    )
